...
////  inmac
////
////  Created by Ria Song on 2021/03/22.
////
//
//import Foundation
//
//protocol StarJsonModelProtocol: class{
//    func starItemDownloaded(items: NSArray) // <- 여기에 담은 아이템을 아래 delegate에서 사용하고, tableView에서 궁극적으로 사용.
//}
//
//class StarJsonModel: NSObject{
//    var delegate: StarJsonModelProtocol!
//    var urlPath = "http://" + Share.macIP + "inmac/star_query_ios.jsp"
//    
...
//                let query = AddressModel(addressNo: address_addressNo, addressName: addressName, addressPhone: addressPhone, addressEmail: addressEmail, addressText: addressText, addressBirth: addressBirth, addressStar: user_userEmail, addressImage: addressImage)
...
//            self.delegate.starItemDownloaded(items: locations)
//            
//        })
//    }
//    
